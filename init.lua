...
require('lazy').setup({
  ...
  --   init = function()
  --     -- Set up the vscode theme with custom highlights
  --     -- Customize highlights for different elements
  --     vim.cmd.colorscheme 'vscode'
  --     -- Example of additional customization: Removing underlines from comments
